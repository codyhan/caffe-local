...
namespace caffe {
    ...
    void ContinuationIndicatorLayer<Dtype>::LayerSetUp(
        ...
        cout <<" indicator LayerSetUp" <<endl;
    ...
    void ContinuationIndicatorLayer<Dtype>::Forward_cpu(
		...
		//ContinuationIndicatorParameter param = this->layer_param().continuation_indicator_param();

		//time_step_ = param.time_step();
		
		cout << "  Forward_cpu time_step is " << time_step_<< endl;
